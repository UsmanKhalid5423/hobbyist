                ...
                switch (_a.label) {
                    case 0:
                        ...
                        params = {
                            ...
                            url: "https://www.walmart.com/search?q=".concat(url),
                    ...
                    case 3:
                        _a.sent();
                        logger_1.logger.info("walmat complete with ".concat(invs_1.length));
                        return [2 /*return*/, invs_1];
                    case 4:
                        error_1 = _a.sent();
                        logger_1.logger.error("walmat ".concat(error_1));
                        return [2 /*return*/, []];
