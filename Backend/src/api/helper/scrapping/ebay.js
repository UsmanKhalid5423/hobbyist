    ...
    Scrapping.prototype.priceToStr = function (price) {
        if (price && (price === null || price === void 0 ? void 0 : price.includes("to"))) {
            var lomerImit = price
                ...
                .replace("to", "").replace(",", "")
                .split(" ")[0];
            var upperLimit = price
                .split("$").join("")
                .replace("to", "").replace(",", "")
                .split(" ")[1];
            var avgPrice = (parseFloat(lomerImit) + parseFloat(upperLimit)) / 2;
    ...
    Scrapping.prototype.getScrappingData = function (search_word, id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        url = search_word.split(" ").join("+");
                        params = {
                            api_key: "DCXO8PT2BDINHZNQDJUMHLK9FYAKG3MDW9U4T1A4G7KNZ4IN7WNYA796GELUFA1KW9VQ7R9ZXSXN28IH",
                            url: "https://www.ebay.com/sch/i.html?_from=R40&_trksid=p2380057.m570.l1313&_nkw=".concat(url, "&_sacat=0"),
                    ...
                    case 3:
                        _a.sent();
                        logger_1.logger.info("ebay complete with ".concat(invs_1.length));
                        return [2 /*return*/, invs_1.slice(1)];
                    case 4:
                        error_1 = _a.sent();
                        logger_1.logger.error("ebay ".concat(error_1));
                        return [2 /*return*/, []];
