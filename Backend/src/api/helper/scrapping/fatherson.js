                ...
                switch (_a.label) {
                    case 0:
                        ...
                        params = {
                            ...
                            url: "https://www.fathersonsport.com/search?q=".concat(url, "&options%5Bprefix%5D=last"),
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, response.map(function (item) { return __awaiter(_this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    ...
                                    if (data.currency != 'No') {
                                        item.link = "https:".concat(item.link);
                                        item.baseCurrency = data.currency;
                                        item.price = data.price;
                                        item.date = new Date();
                                        item.url = "https://fathersonsport.com".concat(item.url);
                                        if (id == null)
                    ...
                    case 3:
                        _a.sent();
                        logger_1.logger.info("fatherson complete with ".concat(invs_1.length));
                        return [2 /*return*/, invs_1];
                    case 4:
                        error_1 = _a.sent();
                        logger_1.logger.error("fatherson ".concat(error_1));
                        return [2 /*return*/, []];
