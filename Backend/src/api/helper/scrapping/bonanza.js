                ...
                switch (_a.label) {
                    case 0:
                        ...
                        params = {
                            ...
                            url: "https://www.bonanza.com/items/search?q[catalog_id]=&q[country_to_filter]=US&q[filter_category_id]=&q[in_booth_id]=&q[ship_country]=1&q[shipping_in_price]=0&q[sort_by]=relevancy&q[suggestion_found]=&q[translate_term]=true&q[search_term]=".concat(url),
                        ...
                        return [4 /*yield*/, response.map(function (item) { return __awaiter(_this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    ...
                                    if (data.currency != 'No') {
                                        ...
                                        item.date = new Date();
                                        item.url = "https://www.bonanza.com".concat(item.url);
                                        if (id == null)
                    ...
                    case 3:
                        _a.sent();
                        logger_1.logger.info("bonanza complete with ".concat(invs_1.length));
                        return [2 /*return*/, invs_1];
                    case 4:
                        error_1 = _a.sent();
                        logger_1.logger.error("Bonanza ".concat(error_1));
                        return [2 /*return*/, []];
