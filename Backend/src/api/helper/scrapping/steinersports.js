                ...
                switch (_a.label) {
                    case 0:
                        ...
                        params = {
                            ...
                            url: "https://www.steinersports.com/?query=".concat(url),
                        ...
                        return [4 /*yield*/, response.map(function (item) { return __awaiter(_this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    ...
                                    if (data.currency != 'No') {
                                        ...
                                        item.date = new Date();
                                        item.url = "https://steinersports.com".concat(item.url);
                                        if (id == null)
                    ...
                    case 3:
                        _a.sent();
                        logger_1.logger.info("steiner complete with ".concat(invs_1.length));
                        return [2 /*return*/, invs_1];
                    case 4:
                        error_1 = _a.sent();
                        logger_1.logger.error("steiner ".concat(error_1));
                        return [2 /*return*/, []];
