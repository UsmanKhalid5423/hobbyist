                ...
                switch (_a.label) {
                    case 0:
                        ...
                        params = {
                            ...
                            url: "https://www.etsy.com/search?q=".concat(url, "&ref=search_bar"),
                    ...
                    case 3:
                        _a.sent();
                        logger_1.logger.info("estay complete with ".concat(invs_1.length));
                        return [2 /*return*/, invs_1];
                    case 4:
                        error_1 = _a.sent();
                        logger_1.logger.error("estay ".concat(error_1));
                        return [2 /*return*/, []];
